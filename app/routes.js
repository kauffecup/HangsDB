...
router.post('/upload', function (req, res) {
  ...
  if (body) {
    connection.addAllToArrangement(dbconnection, body.name, body.opb, body.year, body.arrangedSemester,
      body.quality, body.reception, body.genre, body.arrType, body.nickname, stringToBoolean(body.hasSyllables),
      '', '', body.youtubeLink, body.pitchBlown, body.difficulty, stringToBoolean(body.hasChoreo), body.soloRange,
      body.notes, body.key, '', stringToBoolean(body.isActive), body.numParts, body.arrangedby, body.semestersIn,
